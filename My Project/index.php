...
$query=mysqli_query($con, "insert into tblusers(FirstName,LastName, Cnic, Email, Address,ProfilePic) value('$fname','$lname', '$cnicno', '$email', '$add','$imgnewfile' )");
if ($query) {
...
<div class="signup-form">
    <form  method="POST" enctype="multipart/form-data" >
		<h2>Fill Data</h2>
		<p class="hint-text">Register Your Vote.</p>
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="idno" placeholder="Enter your Cnic Number" required="true" maxlength="15" pattern="[0-9]+">
        </div>
        <div class="form-group">
