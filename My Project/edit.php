...
if(isset($_POST['submit']))
  {
    ...
    //Query for data updation
     $query=mysqli_query($con, "update  tblusers set FirstName='$fname',LastName='$lname', Cnic='$cnicno', Email='$email', Address='$add' where ID='$eid'");
...
<a href="change-image.php?userid=<?php echo $row['ID'];?>">Change Image</a>
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="idno" value="<?php  echo $row['Cnic'];?>" required="true" maxlength="15" pattern="[0-9]+">
        </div>
        <div class="form-group">
